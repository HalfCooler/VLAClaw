"""vlaclaw.backends — Device backend implementations.
...
dependencies for users who only need a subset::
    ...
    from vlaclaw.backends.dry_run import DryRunBackend
    from vlaclaw.backends.desktop import LocalDesktopBackend
"""
